...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted Ragnarok to zRAGNA");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zRAGNA");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received Ragnarok from zRAGNA");
    case TransactionRecord::ZerocoinSpend_Change_zRAGNA:
        return tr("Minted Change as zRAGNA from zRAGNA Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zRAGNA to Ragnarok");
