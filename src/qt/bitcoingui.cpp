                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Ragnarok Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Ragnarok address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ragnarok: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zRAGNA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Ragnarok Core"), this);
    aboutAction->setStatusTip(tr("Show information about Ragnarok Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Ragnarok"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Ragnarok addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Ragnarok addresses"));
    ...
    openAction->setStatusTip(tr("Open a Ragnarok: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Ragnarok Core help message to get a list with possible Ragnarok command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Ragnarok Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Ragnarok Core"); // default title
...
/** Creates context menu, its actions, and ragnaroks up all the relevant signals for mouse events. */
