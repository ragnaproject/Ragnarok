...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ragnarok Core"),
     ...
     * override -datadir in the ragnarok.conf file in the default data directory
     * (to be consistent with ragnarokd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
