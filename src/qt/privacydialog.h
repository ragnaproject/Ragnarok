...
public:
    ...
    void setZRagnarokControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzRAGNA_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzRAGNA_clicked();
    void on_pushButtonZRagnarokControl_clicked();
