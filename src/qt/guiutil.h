...
/** Utility functions used by the Ragnarok Qt UI.
 */
namespace GUIUtil
{
...
// Render Ragnarok addresses in monospace font
...
// Parse "ragnarok:" URI into recipient object, return true on successful parsing
