...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Ragnarok server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ragnarok features */
        {"ragnarok", "masternode", &masternode, true, true, false},
        {"ragnarok", "listmasternodes", &listmasternodes, true, true, false},
        {"ragnarok", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ragnarok", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ragnarok", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ragnarok", "masternodedebug", &masternodedebug, true, true, false},
        {"ragnarok", "startmasternode", &startmasternode, true, true, false},
        {"ragnarok", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ragnarok", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ragnarok", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ragnarok", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ragnarok", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ragnarok", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ragnarok", "mnbudget", &mnbudget, true, true, false},
        {"ragnarok", "preparebudget", &preparebudget, true, true, false},
        {"ragnarok", "submitbudget", &submitbudget, true, true, false},
        {"ragnarok", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ragnarok", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ragnarok", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ragnarok", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ragnarok", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ragnarok", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ragnarok", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ragnarok", "checkbudgets", &checkbudgets, true, true, false},
        {"ragnarok", "mnsync", &mnsync, true, true, false},
        {"ragnarok", "spork", &spork, true, true, false},
        {"ragnarok", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ragnarok", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use ragnarokd, or the -server option to ragnarok-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> ragnarok-cli " + methodname + " " + args + "\n";
}
