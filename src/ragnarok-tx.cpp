...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ragnarok Core ragnarok-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ragnarok-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ragnarok transaction") + "\n" +
                               "  ragnarok-tx [options] -create [commands]   " + _("Create hex-encoded ragnarok transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ragnarok transaction
