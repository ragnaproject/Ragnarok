...
RESOURCES += src/qt/ragnarok.qrc src/qt/ragnarok_locale.qrc

TRANSLATIONS += src/qt/locale/ragnarok_bg.ts \
                src/qt/locale/ragnarok_de.ts \
                src/qt/locale/ragnarok_en.ts \
                src/qt/locale/ragnarok_es.ts \
                src/qt/locale/ragnarok_fi.ts \
                src/qt/locale/ragnarok_fr.ts \
                src/qt/locale/ragnarok_it.ts \
                src/qt/locale/ragnarok_ja.ts \
                src/qt/locale/ragnarok_pl.ts \
                src/qt/locale/ragnarok_pt.ts \
                src/qt/locale/ragnarok_ru.ts \
                src/qt/locale/ragnarok_sk.ts \
                src/qt/locale/ragnarok_sv.ts \
                src/qt/locale/ragnarok_vi.ts \
                src/qt/locale/ragnarok_zh_CN.ts \
                src/qt/locale/ragnarok_zh_TW.ts
