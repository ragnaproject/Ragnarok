Contributing to Ragnarok Core
============================

The Ragnarok Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ragnarok Core project, and is not to be
confused with overall Ragnarok Network Protocol consensus changes.

Whether a pull request is merged into Ragnarok Core rests with the project merge
...
Patches that change Ragnarok consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ragnarok consensus, it must have been
...
The project leader is the release manager for each Ragnarok Core release.
