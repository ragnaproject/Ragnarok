...
In order to support loading of multiple wallets in ragnarok-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ragnarok.cpp.
...
Changes to ragnarok.cpp
----------------------
ragnarok.cpp is the entry point into ragnarok-qt, and as such, will require some minor modifications to provide hooks for
